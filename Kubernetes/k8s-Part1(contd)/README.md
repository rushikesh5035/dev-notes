...
<br>
  ...
  <p align="center">
    <img width="600" alt="image" src="https://github.com/user-attachments/assets/01cfbee5-096c-4d2d-9897-24f0f1b5a09a">
  </p>
...
1. First, we need a deployment configuration file. Check the `k8s/deployment.yml` file:
...
- A `ReplicaSet` is a lower-level concept that manages the number of pods that are running.
  ...
  <p align="center">
    <img width="500" alt="image" src="https://github.com/user-attachments/assets/0296ae96-0edc-45c2-a6d7-c15377c6ecd7">
  </p>
